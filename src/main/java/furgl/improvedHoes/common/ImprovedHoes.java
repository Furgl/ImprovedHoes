...
@Mod(modid = ImprovedHoes.MODID, name = ImprovedHoes.MODNAME, version = ImprovedHoes.VERSION, guiFactory = "furgl.improvedHoes.client.config.ImprovedHoesGuiFactory", updateJSON = "https://raw.githubusercontent.com/Furgl/ImprovedHoes/1.11.2/update.json")
